  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Our terms of service are being finalized. Interim terms: ClearClaim is
          an administrative advocacy service, not a law firm, and does not
          provide legal advice. Use of the service is subject to applicable
          federal and state patient protection laws.
        </p>
        <p
          className="font-[family-name:var(--font-dm-sans)]"
          style={{
